...
if __name__ == '__main__':
    ...
    try:
        existing_results = np.load("extrapolation_kfold_cv_reg_trial8.npy")
    ...
    try:
        _ = np.load("extrapolation_temporary_dataset_count_reg_trial8.npy")
    except:
        np.save("extrapolation_temporary_dataset_count_reg_trial8.npy", [0])
