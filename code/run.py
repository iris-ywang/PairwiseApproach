...
if __name__ == '__main__':
    ...
    try:
        existing_results = np.load("extrapolation_kfold_cv_reg_trial12.npy")
    ...
    try:
        _ = np.load("extrapolation_temporary_dataset_count_reg_trial12.npy")
    except:
        np.save("extrapolation_temporary_dataset_count_reg_trial12.npy", [0])
    ...
    for file in range(len(chembl_info)):
        ...
        np.save("extrapolation_kfold_cv_reg_trial12.npy", np.array(all_metrics))
